...
@section('meta')
       ...
       <meta property="fb:pages" content="squareclubbelgrade">
        ...
        <meta property="og:title" content="Check this week in Club Square" />
            ...
            <div class="breadcrumb-fullscreen-parent phone-menu-bg">
                <div class="breadcrumb breadcrumb-fullscreen alignleft small-description overlay almost-black-overlay" style="background-image:url(<?php echo url("") ?>/images/blog/vaspetaknaslov.jpg);" data-stellar-background-ratio="0.5" data-stellar-vertical-offset="0">
                    <div class="breadTxt breadSingle">
                        ...
                        <p>Nastupaju fenomenalni Nemanja Staletović i Tamara Toković!</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="blog-left">
                <div class="col-sm-8">
                    ...
                    <div class="paragraph">
                        <p>
                            Ovog petka posetite novootvoreni Beogradski noćni klub <b>Square</b> i sigurno nećete pogrešiti. Čekaju vas popularni pevači zabavne i narodne muzike - Nemanja Staletović i Tamara Toković. 
                        </p>
                        <p>
                            <br/><br/>
